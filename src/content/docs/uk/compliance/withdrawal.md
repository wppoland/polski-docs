...
Директива ЄС 2023/2673 вводить нові обов'язки щодо права на відмову від договору, які стають обов'язковими з 19 червня 2026 року. Polski for WooCommerce реалізує повний процес обробки відмови - від форми клієнта, через підтвердження e-mail, до виключень продуктів та хуків для розробників.

## Правові вимоги

Споживач має право відмовитися від договору, укладеного дистанційно, протягом 14 днів без зазначення причини. Продавець зобов'язаний:
...
Директива 2023/2673 розширює ці обов'язки цифровим процесом подання заяв та автоматичними підтвердженнями.

## Процес клієнта

### Крок 1 - кнопка в Мій обліковий запис

Після активації модуля на сторінці **Мій обліковий запис > Замовлення** з'являється кнопка "Відмовитися від договору" при замовленнях, що кваліфікуються для повернення. Кнопка видима лише у період відмови (за замовчуванням 14 днів від доставки).
...
Адміністратор може далі обробити звернення в панелі WooCommerce та позначити його як завершене.

## Виключення продуктів

Право на відмову не поширюється на деякі категорії продуктів. Ви можете позначити продукт як виключений у вкладці **Polski - Відмова** у редагуванні продукту.
...
Для виключеного продукту кнопка "Відмовитися від договору" не відображається в панелі клієнта.
...
Відображає форму, попередньо заповнену даними замовлення з вказаним ID. Система перевіряє, чи авторизований користувач є власником цього замовлення.
...
Далі у налаштуваннях плагіна (**WooCommerce > Налаштування > Polski > Відмова**) вкажіть цю сторінку як сторінку форми за замовчуванням.
...
Адміністратор може змінити статус звернення, додати внутрішню нотатку або обробити повернення безпосередньо з панелі.
