...
Polski for WooCommerce розширює вбудований iмпортер/експортер CSV WooCommerce додатковими колонками для юридичних даних, GPSR, екологiчних заяв та iнших полiв, специфiчних для польського та європейського законодавства.
