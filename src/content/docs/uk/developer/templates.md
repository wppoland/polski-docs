...
Polski for WooCommerce використовує систему шаблонiв, побудовану за зразком WooCommerce. Ви можете перевизначити будь-який шаблон плагiна, скопiювавши його до каталогу `yourtheme/polski/` у вашiй темi.
