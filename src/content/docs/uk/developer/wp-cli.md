...
Polski for WooCommerce надає команди WP-CLI для керування плагiном з командного рядка. Команди дозволяють автоматизувати мiграцii даних та перевiряти правильнiсть конфiгурацii.
