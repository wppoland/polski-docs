...
Польський Закон про права споживачів (ст. 17 п. 3) вимагає, щоб кнопка завершення замовлення в інтернет-магазині була однозначно позначена словами "zamówienie z obowiązkiem zapłaty" або рівнозначним формулюванням. Плагін Polski for WooCommerce автоматично змінює текст кнопки WooCommerce за замовчуванням на відповідний польському законодавству.

## Правові вимоги

Відповідно до ст. 17 п. 3 Закону про права споживачів, що імплементує директиву 2011/83/ЄС:
