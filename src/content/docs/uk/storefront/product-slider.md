...
Слайдер продуктів відображає карусель продуктів з плавним прокручуванням на основі CSS scroll-snap. Модуль не потребує зовнішніх JavaScript-бібліотек (Slick, Swiper) - використовує виключно нативні механізми браузера.
