...
Модуль передпродажу дає змогу позначати продукти як доступні у передпродажу, відображати дату релізу, змінювати текст кнопки покупки та контролювати змішування продуктів pre-order зі стандартними в кошику. Корисний у магазинах з електронікою, книгами, іграми та будь-яким асортиментом, де продукти пропонуються до офіційної дати доступності.
