...
Каталоговий режим перетворює магазин WooCommerce на каталог продуктів без можливості покупки. Ціни можуть бути приховані, кнопки "Додати до кошика" замінені повідомленнями або перенаправлені до форми запиту пропозиції. Модуль призначений переважно для магазинів B2B, де ціни обговорюються індивідуально, та для магазинів, що хочуть представити пропозицію без можливості прямих покупок.
