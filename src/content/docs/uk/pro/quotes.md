...
Модуль запитів пропозицій (RFQ) замінює кнопку "Додати до кошика" на "Запитати ціну". Клієнти подають запити замість прямих покупок. Корисно в магазинах B2B та при продуктах з індивідуальною оцінкою.
