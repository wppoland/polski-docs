...
Nutri-Score - це система маркування харчових продуктів, розроблена Sante publique France, яка оцінює харчову якість продукту за п'ятибальною шкалою від A (найкраща) до E (найгірша). Хоча в Польщі використання Nutri-Score є добровільним, все більше виробників вирішують розміщувати його на упаковках. Плагін Polski for WooCommerce дозволяє відображати позначку Nutri-Score на сторінці продукту.
