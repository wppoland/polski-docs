...
Регламент (ЄС) nr 1169/2011 (додаток II) визначає 14 речовин, що спричиняють алергії або реакції непереносимості, які повинні бути чітко позначені на етикетці харчового продукту. У випадку інтернет-продажу інформація про алергени повинна бути доступна перед покупкою. Плагін Polski for WooCommerce забезпечує систему декларування алергенів на основі таксономії WordPress.
