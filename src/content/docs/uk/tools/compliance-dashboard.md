...
description: Панель контролю правових вимог в Polski for WooCommerce - контрольний список з кольоровим статусом для кожної вимоги.
---

Панель вiдповiдностi (compliance dashboard) - це центральне мiсце для монiторингу стану правових вимог магазину WooCommerce. Dashboard вiдображає контрольний список зi статусами для кожної юридичної вимоги - вiд регламенту до GPSR та DSA.
