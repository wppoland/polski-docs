...
Реєстр iнцидентiв безпеки дозволяє документувати та керувати подiями безпеки в магазинi WooCommerce. Функцiя пiдтримує вiдповiднiсть Cyber Resilience Act (CRA) - регламенту ЄС, що вимагає вiд продавцiв ведення реєстру iнцидентiв, пов'язаних з продуктами з цифровими елементами.
