...
Polski for WooCommerce rozširuje vstavaný importér/exportér CSV WooCommerce o ďalšie stĺpce pre právne údaje, GPSR, environmentálne vyhlásenia a ďalšie polia špecifické pre poľské a európske právo.
