...
Polski for WooCommerce sprístupňuje tri Gutenberg bloky na vkladanie obchodných modulov v blokovom editore. Každý blok ponúka náhľad v editore (server-side render) a plnú konfiguráciu v bočnom paneli.
