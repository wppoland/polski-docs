...
Smernica EÚ 2023/2673 zavádza nové povinnosti týkajúce sa práva na odstúpenie od zmluvy, ktoré sa stávajú záväznými od 19. júna 2026. Polski for WooCommerce implementuje kompletný proces obsluhy odstúpenia - od formulára zákazníka, cez e-mailové potvrdenia, po produktové výnimky a hooky pre vývojárov.
...
Smernica 2023/2673 rozširuje tieto povinnosti o digitálny proces podávania vyhlásení a automatické potvrdenia.
...
Po kliknutí na tlačidlo zákazník prejde na formulár, ktorý obsahuje:
...
Právo na odstúpenie neprislúcha v prípade niektorých kategórií produktov. Môžete označiť produkt ako vylúčený v záložke **Polski - Odstúpenie** v úprave produktu.
...
Zobrazí formulár predvyplnený údajmi objednávky s uvedeným ID. Systém overí, či prihlásený používateľ je vlastníkom tejto objednávky.
...
Potom v nastaveniach pluginu (**WooCommerce > Nastavenia > Polski > Odstúpenie**) uveďte túto stránku ako predvolenú stránku formulára.
...
Hlásenia o odstúpení sú dostupné v paneli WooCommerce pod **WooCommerce > Odstúpenia**. Každé hlásenie obsahuje:
